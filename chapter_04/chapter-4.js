...
// Вычисление корреляции между двумя логическими переменными
// Выходными данными формулы является таблица частот, содержащая количество раз,
// когда наблюдались различные комбинации переменных
// Результатом формулы будет число в диапазоне от -1 до 1, описывающее корреляцию.
// Если представить таблицу 2х2 как массив:
...
function phiDestruction([n00, n01, n10, n11]) {
  return (
    (n11 * n00 - n10 * n01) /
...
let nums = [4, 1, -2, 7];
console.log(max(...nums)); // why don't work? console.log(max(nums));
